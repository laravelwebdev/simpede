...
<html>
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css?family=Abril+Fatface|Barlow+Condensed:400,400i,700,700i"
      rel="stylesheet"
    />
    <style>
      * {
    ...
    <div class="container">
      ...
      <div class="login-content">
        <div class="blockquote">
          ...
          <a href="app/login">
            <h4 style="color: #292a2b">Login</h4>
          </a>
        </div>
      </div>
      <div class="footer">
        <p>
          Sistem Integrasi Pekerjaan dan Dokumentasi secara Elektronik &middot; v.{{
          $version }}
        </p>
