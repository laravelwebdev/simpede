...
<html lang="en" data-theme="light">
    ...
    <body class="h-screen  flex items-center">
        <div class="justify-center h-screen w-screen bg-gray-100 flex items-center dark:bg-gray-700">
            <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700 dark:text-gray-400">
                <div class="max-w-md">
                    <div class="text-5xl text-green-500 font-dark font-bold">@yield('code')</div>
                    <p
                        class="text-2xl mb-4 md:text-3xl font-light leading-normal"
                        >@yield('message')</p>
                    <p class="italic">"@yield('quote')"</p>
                    <div class="text-lg text-green-500 font-dark font-bold">- @yield('author') -</div>
                </div>
                <div class="max-w-lg">
