    ...
    public function cards()
    {
        return [
            ...
            WelcomeCard::make()
                ...
                ->addItem(icon: 'user-group', title: 'Pengelolaan Kontrak Kegiatan Bulanan Mitra', content: 'Fitur yang disediakan untuk memonitor kesesuaian kontrak dengan SBML, mencetak kontrak dan BAST, mencetak SK, Surat Tugas dan SPJ Honor Mitra serta Mengarsipkan Softcopy Kontrak dan BAST.')
