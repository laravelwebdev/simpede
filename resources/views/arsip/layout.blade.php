...
<html lang="id">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/arsip.min.css') }}">
    ...
    <body>
        ...
        <main>
            <div class="page-title">
                <h1>Arsip Dokumen Tahun Anggaran {{ $tahun }}</h1>
                <p>Per {{ $level }}</p>
            </div>
            <div class="container">
                @yield('table')                
        ...
        <footer>
            ...
            <p class="text-footer">
                ...
                <a class="link-footer" href="{{ config('satker.website') }}" target="_blank">
                {{ $satker }}
                </a>
            </p>
        </footer>
        @yield('script')
        <script>
            // Tambahkan data-label otomatis ke td
            ...
            const updateThemeIcon = (theme) => {
              ...
              if(theme === 'light') sunIcon.classList.remove('is-hidden');
              else if(theme === 'dark') moonIcon.classList.remove('is-hidden');
              else systemIcon.classList.remove('is-hidden');
            };
