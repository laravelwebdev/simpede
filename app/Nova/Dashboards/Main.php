    ...
    public function cards()
    {
        ...
        $cards = [
            ...
            Welcome::make()
                ...
                ->addItem(icon: 'film', title: 'Dokumentasi Kegiatan', content: 'Fitur yang disediakan untuk menyimpan dokumentasi foto-foto kegiatan.')
                ->addItem(icon: 'link', title: 'Dokumentasi Link', content: 'Fitur yang disediakan untuk menyimpan link-link penting.')
