...
class AnnounceEom extends Action
{
    ...
    public function handle(ActionFields $fields, Collection $models)
    {
        ...
        $pesan = '*_[Employee Of The Month_ Bulan '.Helper::BULAN[$model->bulan].' '.$model->tahun."]*\n\n🎉Selamat Kepada ".optional(Helper::getPegawaiByUserId($model->user_id))->name." yang terpilih sebagai _Employee of the Month_ bulan ini! Terima kasih atas dedikasi dan kerja kerasnya 👏🔥\nLink Sertifikat Penghargaan: \n".Storage::disk('arsip')->url($model->arsip_sertifikat)." \n\nTerimakasih ✨✨";
