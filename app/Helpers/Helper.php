    ...
    public static function makeCollectionForMassFt($honor_kegiatan_id, $tanggal, $satker_rekening, $remark)
    {
        return self::makeBaseListMitraAndPegawai($honor_kegiatan_id, $tanggal)
            ...
            ->transform(function ($item, $index) use ($satker_rekening, $remark) {
                ...
                $item['BenBankIdentifier'] = optional(self::getKodeBankById($item['kode_bank_id']))->kode;
                $item['Credit Account'] = $item['rekening'];
                $item['Beneficiary Name'] = $item['nama'];
                $item['Beneficiary Address'] = config('satker.kabupaten');
                ...
                $item['Ben Mobile Number'] = '';
                $item['Sender Country Code'] = '';
                $item['Beneficiary Country Code'] = '';
                $item['BenBankName'] = '';
                $item['BenBankAddress'] = '';
                $item['BenBankCountryCode'] = '';
                $item['InterBankIdentifier'] = '';
                $item['InterBankName'] = '';
                $item['InterBankAddress'] = '';
                $item['InterBankCountryCode'] = '';
                $item['Beneficiary Category'] = '';
                $item['Beneficiary Relation'] = '';
                $item['BI Transaction Code'] = '';
                $item['Simodis Info'] = '';
                $item['Enrichment Details 1'] = '';
                $item['Enrichment Details 2'] = '';
                $item['Enrichment Details 3'] = '';
                $item['Enrichment Details 4'] = '';
                unset($item['nip_lama']);
                unset($item['volume']);
                unset($item['harga_satuan']);
                unset($item['persen_pajak']);
