    ...
    public function cards()
    {
        ...
        return [
            ...
            WelcomeCard::make()
                ...
                ->addItem(icon: 'user-group', title: 'Pengelolaan Kontrak Mitra Statistik', content: 'Fitur yang disediakan untuk memonitor kesesuaian kontrak dengan SBML, mencetak kontrak dan BAST, mencetak SK, mengeksport template BOS, export template CMS BRI, surat Tugas dan SPJ Honor Mitra serta Mengarsipkan Softcopy Kontrak dan BAST.')
