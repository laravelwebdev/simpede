    ...
    public function fields(NovaRequest $request)
    {
        return [
            Stack::make('Nomor/tanggal', 'tanggal_permintaan', [
                BelongsTo::make('Nomor', 'naskahKeluar', \App\Nova\NaskahKeluar::class)
                    ->exceptOnForms(),
            ...
            Textarea::make('Catatan', 'keterangan')
                ->rules('required')
                ->alwaysShow(),
            BelongsTo::make('Pemohon', 'user', \App\Nova\User::class)
                ->sortable()
                ->filterable()
                ->exceptOnForms(),
            Date::make('Tanggal Persetujuan', 'tanggal_persetujuan')
                ...
                ->canSee(fn () => Policy::make()
                    ->allowedFor('bmn')
                    ->get()),
            BelongsTo::make('Pengelola Persediaan', 'pbmn', \App\Nova\User::class)
                ->exceptOnForms()
                ->sortable()
                ->canSee(fn () => Policy::make()
                    ->allowedFor('bmn')
